...
# mhf bbox_overlaps withdrawn in v3 ... NO just moved?
# from mmdet.legacy import bbox_overlaps
...
class NMSHead(BaseModule):
    """NMS prediction head from paper:
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(NMSHead, self).__init__(init_cfg)
